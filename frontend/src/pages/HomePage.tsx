...
import { Card, Separator, Sheet, SheetContent, SheetFooter, SheetHeader, SheetTitle, } from '@/components/ui';
import { Search, Grid, Lupe, TrendingUp, Calendar, Users, Star, } from 'lucide-react';
          ...
          <section className="mb-12">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  className="inline-flex items-center px-6 py-3 border border-border rounded-full hover:bg-background transition-colors"
                >
                  Browse Categories
                </button>
              </div>
          ...
          <section className="mb-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {categories.map((category, index) => (
                <Card
                  key={index}
                  className="p-4 text-center hover:bg-primary/5 transition-colors"
                >
          ...
          <section className="mt-12 pt-8 border-t border-border">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted">Positive Reviews</p>
              </div>
              <div className="text-center">
