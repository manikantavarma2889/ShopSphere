...
export const AdminProductsPage = React.memo(() => {
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <Card className="bg-white rounded-lg shadow-sm border-border overflow-x-auto">
            <div className="p-6 border-b border-border">
              <h2 className="font-medium text-foreground">Products</h2>
            </div>
                    ...
                    <tr key={product.id} className="border-b">
                      ...
                      <td className="p-4">
                        <div className="flex gap-2">
                          <Button onClick={() => handleEditProduct(product)} className="flex-1 text-xs text-primary hover:underline">
                            Edit
                          </Button>
                          <Button onClick={() => handleDeleteProduct(product.id)} className="text-xs text-destructive hover:underline">
                            Delete
                          </Button>
                          <Button onClick={() => handleToggleActive(product.id)} className="text-xs text-primary hover:underline">
          ...
          {products.length === 0 && (
            <p className="text-muted text-center py-12">No products found. Add your first product.</p>
          )}
