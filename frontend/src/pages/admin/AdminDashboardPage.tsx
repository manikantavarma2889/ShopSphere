        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {dashboardMetrics.map((metric) => (
              <Card key={metric.label} className="p-6 bg-white rounded-lg shadow-sm border-border">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="h-full">
              <div className="p-4">
                <h3 className="text-sm font-medium text-foreground mb-4">Orders This Month</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 mb-8">
            <Card className="p-4"><Box className="h-6 w-6 mb-3 text-primary" /><span className="text-sm font-medium">Products</span></Card>
            <Card className="p-4"><TrendingUp className="h-6 w-6 mb-3 text-success" /><span className="text-sm font-medium">Orders</span></Card>
            <Card className="p-4"><Users className="h-6 w-6 mb-3 text-primary" /><span className="text-sm font-medium">Users</span></Card>
            <Card className="p-4"><Calendar className="h-6 w-6 mb-3 text-primary" /><span className="text-sm font-medium">Analytics</span></Card>
          </div>
        </div>
      </main>
    </div>
